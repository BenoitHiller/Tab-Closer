...
document.addEventListener('DOMContentLoaded', function () {
  setup(pageManager);
  document.querySelector("#info-button").addEventListener("click", toggle_help.bind(this,"general-help"));
  document.querySelector("#regex-button").addEventListener("click", toggle_help.bind(this,"regex-help"));
  document.querySelector("#matcher-button").addEventListener("click", toggle_help.bind(this,"matcher-help"));
